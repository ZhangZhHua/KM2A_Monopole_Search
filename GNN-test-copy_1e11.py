...
def main(data_file,csv_file,  model_file,version='1e9_V04'):
    ...
    train_dataset = AirShowerGraphDataset_new(hitsE_train, hitsM_train, labels_train, csv_feats=train_csv, only_ED=True,k=10)
    val_dataset   = AirShowerGraphDataset_new(hitsE_val, hitsM_val, labels_val, csv_feats=val_csv, only_ED=True,k=10)
