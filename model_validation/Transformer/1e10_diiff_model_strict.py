...
def train_and_validate(signal_file,bkg_file,param_keys,use_hitsM=False,epochs=50,batch_size=128,lr=2e-4,device='cuda',max_hits=1024,val_fraction=0.2,
    ...
    scheduler = warmup_cosine_schedule(opt, warmup_epochs=10, total_epochs=30, base_lr=lr)
...
# /home/zhonghua/miniconda3/bin/python /home/zhonghua/Filt_Event/model_validation/Transformer/1e10_diiff_model_strict.py
if __name__ == "__main__":
    ...
    out_dir = "/home/zhonghua/Filt_Event/model_validation/Transformer/1e10_QG_based_strict"
    signal_file = "/home/zhonghua/data/Dataset_Filted/filted_Monopole_1e10_merged_1000_70_new_dataset_strict.npz"
    bkg_file = "/home/zhonghua/data/Dataset_Filted/1e10_V03/Proton_all_combined_filted_1e10_V03_12_16_dataset_strict.npz"
    os.makedirs(out_dir, exist_ok=True)
    model = train_and_validate(signal_file,bkg_file, param_keys, use_hitsM=use_hitsM, epochs=200, batch_size=64, lr=1e-3,
