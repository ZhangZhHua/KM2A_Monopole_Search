...
void RunLimit_Plot() {
    ...
    calc.SetFixedScan(50, 0.0, 0.003); 
    ...
    c1->SaveAs("./figures/1e12_CLs_scan.png");
    c1->SaveAs("/data/home/zzh/Filt_Event/Note_Writing/figures/1e12_CLs_scan.pdf");
    ...
    c2->SaveAs("./figures/1e12_bkg_fig_hist.png");
    c2->SaveAs("/data/home/zzh/Filt_Event/Note_Writing/figures/1e12_bkg_fig_hist.pdf");
