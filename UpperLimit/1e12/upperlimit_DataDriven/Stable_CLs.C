...
void Stable_CLs() {
    ...
    fc.SetToys(5000, 3000); // 1000 个 Toy 足够画出漂亮的巴西图
    fc.UseSameAltToys();
    // ------------------------------------------------------------------
    ...
    c1->SaveAs("./figures/Stable_1e12_CLs_scan.png");
    c1->SaveAs("/data/home/zzh/Filt_Event/Note_Writing/figures/Stable_1e12_CLs_scan.pdf");
  ...
  // ==========================================================
    ...
    lat.DrawLatex(0.25, 0.78, "Monopole Analysis, #gamma = 10^{7}");
    ...
    frame2->GetYaxis()->SetRangeUser(-2, 4.0); 
    frame2->GetYaxis()->SetNdivisions(505);
    ...
    c2->SaveAs("./figures/Stable_1e12_bkg_fig_hist_Fre.png");
    c2->SaveAs("/data/home/zzh/Filt_Event/Note_Writing/figures/Stable_1e12_bkg_fig_hist_Fre.pdf");
