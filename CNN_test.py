...
if __name__ == "__main__":
    ...
    # pre_loadDataset4Train(inputfilelist,outputfile,sample_num=sample_num)
    # pre_loadDataset4Train_filted(npzfiles=gamma_files[0],csvfiles=gamma_files[1],outfile=gamma_file_out,sample_num=sample_num[0])
    # pre_loadDataset4Train_filted(npzfiles=proton_files[0],csvfiles=proton_files[1],outfile=proton_file_out,sample_num=sample_num[1])
    # pre_loadDataset4Train_filted(npzfiles=monopole_files[0],csvfiles=monopole_files[1],outfile=monopole_file_out,sample_num=sample_num[2])
    # pre_loadDataset4Train(inputfilelist,outputfile)

    model_file="/home/zhonghua/Filt_Event/models/best_cnn_model_new_loss_ED_1.pt"
